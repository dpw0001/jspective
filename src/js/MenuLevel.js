...
export class MenuLevel {
    constructor(jspective, menuLevelId, groundLevel, menuAvatar) {
        ...
        if (menuAvatar != null) {
            this.animationMode = menuAvatar.defaultAnimationMode;
        }
        this.animIterator = 0;
        this.wheelRadius = 0;
    ...
    calcWheelRadius() {
        ...
        if (this.wheelRadius < 150) {
            this.wheelRadius = 150;
        }
        if (this.wheelRadius > 400) {
            this.wheelRadius = 400;
        }
    }
    ...
    animateWheel() {
        ...
        if (this.animIterator > 2 * Math.PI) {
            this.animIterator = 0;
        }
    }
} // end class
//# sourceMappingURL=MenuLevel.js.map