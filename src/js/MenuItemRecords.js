...
export class MenuItemRecords {
    ...
    addEntry(itemType, label, hideLabel, contentUrl, width, height, imageUrl, defaultAnimationMode) {
    ...
    parseXML(menuXML) {
        ...
        $("menu > *", menuXML).each(function () {
            ...
            if ($(this).children("url")) {
                contentUrl = $(this).children("url").text();
            }
            if ($(this).children("image").length > 0) {
                ...
                if (imgTag != null) {
                    ...
                    let attrWidth = imgTag.getAttribute("width");
                    if (attrWidth != null) {
...
//# sourceMappingURL=MenuItemRecords.js.map