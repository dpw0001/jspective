...
export class PageAvatar extends Avatar implements IMenuItem {
	...
	constructor(jspective: JSpective, menuItemId: number, isExternal: boolean, label: string, hideLabel: boolean, dataUrl: string,
				parentMenuLevel: MenuLevel, width: number, height: number, baseCssClass: string, imageUrl: string) {
	...
	public onRequestSuccess(responseData: any): void {
		this.jspective.uniquePageViewer.setContent(responseData);
	}


	public onRequestError(xmlHttpReq: any, errStr: any, exceptionObj: any): void {
